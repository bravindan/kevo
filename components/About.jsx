...
export default function About() {
  return (
    <div
      id="about"
      className="flex w-full min-h-[100vh] bg-gradient-to-l from-red-400 to-transparent "
    >
            ...
            <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
                ...
                <Slider className="" {...settings}>
                  <div>
                    <img
                      ...
                      width=""
                      height=""
                      className="w-full h-auto md:h-[460]"
                    />
                  </div>
                  <div>
                    <img
              ...
              <div className=" md:7/12 lg:w-6/12 animate__animated animate__zoomInRight">
                ...
                <div className="mt-4">
                  ...
                  <ul className="mt-6 flex flex-wrap md:flex md:gap-1">
                    {skills.map((skill, index) => (
                      <li
                        key={index}
                        className="bg-black/30 dark:bg-black/40 p-1 rounded-xl text-sm md:text-xs "
                      >
                        {skill}
                      </li>
                    ))}
